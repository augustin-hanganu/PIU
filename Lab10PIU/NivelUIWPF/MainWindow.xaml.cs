...
namespace NivelUIWPF
{
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        // Cerinta 1: proprietate legata prin Binding pentru numarul de studenti
        ...
        private void AfiseazaStudenti()
        {
            ...
            // Cerinta 1: setare prin proprietate cu Binding in loc de lblNrStudenti.Content direct
            NumarStudenti = studenti.Count;
        ...
        private void btnActualizeaza_Click(object sender, RoutedEventArgs e)
        {
            ...
            // Cerinta 2: Prenume este deja actualizat automat prin Binding TwoWay

            // Cerinta 3: aplica notele din TextBox in obiectul Student curent
            StudentCurent.ExtrageNote(txtNote.Text.Trim());

            // Cerinta 3: aplica disciplinele selectate in obiectul Student curent
            StudentCurent.Discipline = new List<string>(disciplineSelectate);

            // Cerinta 4: FormaFinantare si ProgramSTD sunt deja actualizate prin Binding TwoWay
        ...
        private void dgStudenti_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            // Cerinta 3: populeaza checkboxurile disciplinelor din studentul selectat
            disciplineSelectate.Clear();
            disciplineSelectate.AddRange(StudentCurent.Discipline ?? new List<string>());

            cbPIU.IsChecked = disciplineSelectate.Contains("PIU");
            cbPCLP.IsChecked = disciplineSelectate.Contains("PCLP");
            cbPOO.IsChecked = disciplineSelectate.Contains("POO");
            cbDCE.IsChecked = disciplineSelectate.Contains("DCE");
            cbFizica.IsChecked = disciplineSelectate.Contains("Fizica");

            // Cerinta 3: populeaza notele in TextBox din studentul selectat
            txtNote.Text = StudentCurent.NoteAfisare;
